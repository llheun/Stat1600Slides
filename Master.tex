...
\vspace{3mm}
  ...
  490, 700, 740, 910, 340, 1200, 350, 280, 140, 700
...
\item<5->
\begin{equation*}
\bar{X} = \frac{490 + 700 + \cdots + 700}{10} = 585
\end{equation*}
\end{itemize}
...
\begin{itemize}
\item<1-> That is, the average rent for 2-bedroom apartments in  Kalamazoo area is \$ 585 in our sample
...
140, 280, 340, 350, 490, 700, 700, 740, 910, 1200
\item<2->
\begin{equation*}
...
\item<4-> The MED remains unchanged (\$ 595) but $\bar{X} = 581$, down by from the original data (\$ 585).
\end{itemize}
\end{frame}
...
{\footnotesize{
\begin{itemize}
\item<1-> Step 1. Compute $\bar{x} = 585$
...
\begin{equation*}
SD = \sqrt{ \frac{\ensuremath{9.4965\times 10^{5}}}{ 10 - 1 }} = 324.8
\end{equation*}
...
\begin{itemize}
\item<1-> Recall that the mean and SD are \$ $585 \pm 324.8$ \\ ($\pm$ means `give or take')
\item<2-> Get a roommate and pay half the rent: \$ $292.5 \pm 162.4$ %$323  ± $52
\item<3-> No roommate but has contribution of \$100 per month from parents: $292.5 \pm 324.8$    % $526 ± $104
\end{itemize}
\end{frame}
