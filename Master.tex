...
\item<2-> Get a roommate and pay half the rent: \$ $293.5 \pm 142.6$ %$323  ± $52
\item<3-> No roommate but has contribution of \$100 per month from parents: $293.5 \pm 285.2$    % $526 ± $104
\end{itemize}
\end{frame}
...
% {\footnotesize{
% \begin{eqnarray*}
% sumZ &=& \sum Zx * Zy = tmp13b \\
% r    &=& \frac{ tmp13b}{ (n13s - 1)} = r13a
% \end{eqnarray*}
% }}
% 
% {\small{
