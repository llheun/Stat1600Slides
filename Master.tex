...
\item<5->
\begin{equation*}
\bar{X} = \frac{280 + 140 + \cdots + 910}{10} = 477
\end{equation*}
\end{itemize}
...
\begin{itemize}
\item<1-> That is, the average rent for 2-bedroom apartments in  Kalamazoo area is \$ 477 in our sample
...
\item<4-> The MED remains unchanged (\$ 345) but $\bar{X} = 473$, down by from the original data (\$ 477).
\end{itemize}
\end{frame}
...
\begin{eqnarray*}
\bar{X}_{tr} &=& \frac{220+250+280+340+350+700+700+880}{8} \\
     &=&465
\end{eqnarray*}
\end{itemize}
}}
...
{\footnotesize{
\begin{itemize}
\item<1-> Step 1. Compute $\bar{x} = 477$
...
\begin{equation*}
SD = \sqrt{ \frac{\ensuremath{7.5421\times 10^{5}}}{ 10 - 1 }} = 289.5
\end{equation*}
...
\begin{itemize}
\item<1-> Recall that the mean and SD are \$ $477 \pm 289.5$ \\ ($\pm$ means `give or take')
\item<2-> Get a roommate and pay half the rent: \$ $238.5 \pm 144.7$ %$323  ± $52
\item<3-> No roommate but has contribution of \$100 per month from parents: $238.5 \pm 289.5$    % $526 ± $104
\end{itemize}
\end{frame}
