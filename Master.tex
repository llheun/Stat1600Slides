...
\vspace{3mm}
  ...
  560, 700, 740, 760, 490, 500, 220, 880, 700, 140
...
\item<5->
\begin{equation*}
\bar{X} = \frac{560 + 700 + \cdots + 140}{10} = 569
\end{equation*}
\end{itemize}
...
140, 220, 490, 500, 560, 700, 700, 740, 760, 880
\item<2->
\begin{equation*}
...
\item<4-> The MED remains unchanged (\$ 630) but $\bar{X} = 565$, down by from the original data (\$ 569).
\end{itemize}
\end{frame}
...
\begin{equation*}
SD = \sqrt{ \frac{\ensuremath{5.1369\times 10^{5}}}{ 10 - 1 }} = 238.9
\end{equation*}
...
\begin{itemize}
\item<1-> Recall that the mean and SD are \$ $569 \pm 238.9$ \\ ($\pm$ means `give or take')
\item<2-> Get a roommate and pay half the rent: \$ $284.5 \pm 119.5$ %$323  ± $52
\item<3-> No roommate but has contribution of \$100 per month from parents: $284.5 \pm 238.9$    % $526 ± $104
\end{itemize}
\end{frame}
...
\includegraphics[width=4cm]{figure/LBL10a-1} 
