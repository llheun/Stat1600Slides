...
\vspace{3mm}
  ...
  670, 1200, 650, 340, 140, 380, 740, 350, 910, 280
...
\item<5->
\begin{equation*}
\bar{X} = \frac{670 + 1200 + \cdots + 280}{10} = 566
\end{equation*}
\end{itemize}
...
\begin{itemize}
\item<1-> That is, the average rent for 2-bedroom apartments in  Kalamazoo area is \$ 566 in our sample
...
140, 280, 340, 350, 380, 650, 670, 740, 910, 1200
\item<2->
\begin{equation*}
...
\item<4-> The MED remains unchanged (\$ 515) but $\bar{X} = 562$, down by from the original data (\$ 566).
\end{itemize}
\end{frame}
...
{\footnotesize{
\begin{itemize}
\item<1-> Step 1. Compute $\bar{x} = 566$
...
\begin{equation*}
SD = \sqrt{ \frac{\ensuremath{9.6404\times 10^{5}}}{ 10 - 1 }} = 327.3
\end{equation*}
...
\begin{itemize}
\item<1-> Recall that the mean and SD are \$ $566 \pm 327.3$ \\ ($\pm$ means `give or take')
\item<2-> Get a roommate and pay half the rent: \$ $283 \pm 163.6$ %$323  ± $52
\item<3-> No roommate but has contribution of \$100 per month from parents: $283 \pm 327.3$    % $526 ± $104
\end{itemize}
\end{frame}
