...
\vspace{3mm}
  ...
  880, 380, 650, 910, 760, 560, 340, 740, 220, 500
...
\item<5->
\begin{equation*}
\bar{X} = \frac{880 + 380 + \cdots + 500}{10} = 594
\end{equation*}
\end{itemize}
...
\begin{itemize}
\item<1-> That is, the average rent for 2-bedroom apartments in  Kalamazoo area is \$ 594 in our sample
...
220, 340, 380, 500, 560, 650, 740, 760, 880, 910
\item<2->
\begin{equation*}
...
\item<4-> The MED remains unchanged (\$ 605) but $\bar{X} = 582$, down by from the original data (\$ 594).
\end{itemize}
\end{frame}
...
{\footnotesize{
\begin{itemize}
\item<1-> Step 1. Compute $\bar{x} = 594$
...
\begin{equation*}
SD = \sqrt{ \frac{\ensuremath{4.9384\times 10^{5}}}{ 10 - 1 }} = 234.2
\end{equation*}
...
\begin{itemize}
\item<1-> Recall that the mean and SD are \$ $594 \pm 234.2$ \\ ($\pm$ means `give or take')
\item<2-> Get a roommate and pay half the rent: \$ $297 \pm 117.1$ %$323  ± $52
\item<3-> No roommate but has contribution of \$100 per month from parents: $297 \pm 234.2$    % $526 ± $104
\end{itemize}
\end{frame}
